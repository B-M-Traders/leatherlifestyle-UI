...
const Testimonials = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 md:px-16 lg:px-32 py-12 md:py-8 space-y-8 lg:space-y-10 lg:py-14">
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <Rate
            ...
            disabled
          />
          <p className="text-center text-templateBrown text-sm font-light tracking-wide leading-tight">
            {testimonials[selectedIndex].review}
          </p>
          <span className="flex items-center gap-0.5 text-lg text-templateBrown tracking-wide">
