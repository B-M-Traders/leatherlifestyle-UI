        ...
        <div className={`flex flex-col w-full ${className ?? ""}`}>
            <div className="flex relative z-0 w-full text-sm text-gray-800 font-normal">
                <input
                    ...
                    name={name}
                    {...props}
                    className={clsx("block w-full h-11 pt-4 pb-0.5 px-4 mt-0 bg-slate-100 border appearance-none focus:outline-none focus:ring-0 focus:shadow-borders-interactive-with-active hover:bg-slate-200",
                        {
                ...
                <label
                    ...
                    className={clsx("flex pb-1 items-center text-sm justify-center mx-3 px-1 transition-all absolute duration-300 top-3 origin-center text-gray-800",
                        {
            ...
            {helperText && (
                <p id={`${id}-helper-text`} className={clsx(
                    "mt-2 text-xs",
                    {
                        "text-gray-600": status === "default",
                        "text-green-600": status === "success",
