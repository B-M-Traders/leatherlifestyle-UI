...
const Footer = ({ initialRegion }: any) => {
  ...
  return (
    <div className="bg-templateBrown pb-4 lg:pb-0">
      ...
      <div className="templateContainer h-[1px] w-full bg-white opacity-20"></div>

      {/* Copyright */}
      <div className="bg-templateBrown p-4 text-center text-white text-sm flex flex-col-reverse md:flex-row gap-2 items-center justify-between tracking-wide templateContainer">
        <p>© {new Date().getFullYear()} Artisan Hide</p>
        <RegionModal initialRegion={initialRegion} />
      </div>
    </div>
  );
};
